//run once for inserting all products into DB
...
async function run() {
  try {
    ...
    // Inserting all products in JSON format into the collection 'products' under database 'ecomm'
    const allProducts = [
        {
        "id": 1,
    ...
    if(products.length == 0) // insert only if 'products' collection is empty!
    {
